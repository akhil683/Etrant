...
const weeklyActivity = [
  { week: "Week 1", reels: 45, quizzes: 23, hours: 8.5 },
  { week: "Week 2", reels: 52, quizzes: 31, hours: 10.2 },
  { week: "Week 3", reels: 38, quizzes: 19, hours: 7.1 },
  { week: "Week 4", reels: 61, quizzes: 35, hours: 12.3 },
];
    ...
    <div className="min-h-screen bg-gray-950 text-white py-20 px-4">
      <div className="container mx-auto max-w-7xl">
        <div className="space-y-12">
          {/* Profile Header */}
          <div className="flex flex-col md:flex-row items-center md:justify-between bg-gray-900 border border-gray-800 rounded-2xl p-8 shadow-lg">
            <div className="flex items-center gap-6">
              ...
              <div>
                ...
                <p className="text-lg text-gray-300 mb-1">{user.rank}</p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className="bg-gray-900/50 border-gray-800 h-full hover:border-blue-700 transition-colors">
              ...
              <CardContent>
                ...
                <p className="text-xs text-green-400 mt-1">+2,500 this month</p>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gray-900/50 border-gray-800 h-full hover:border-purple-700 transition-colors">
              ...
              <CardContent>
                ...
                <p className="text-xs text-purple-400 mt-1">Top 5% worldwide</p>
              </CardContent>
            </Card>
                ...
                {dailyPoints.map((data, index) => (
                  ...
                  >
                    <div className="relative">
                      <div
                        className="w-10 rounded-t-lg bg-gradient-to-t from-blue-500 to-purple-500 transition-all duration-500 ease-out hover:from-blue-400 hover:to-purple-400 cursor-pointer"
                        style={{
